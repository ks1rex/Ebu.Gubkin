...
const S: Record<string, any> = {
  ...
  typeBadge: (color: string) => ({ display: 'inline-flex', alignItems: 'center', gap: 5, background: color + '18', color, border: `1px solid ${color}33`, borderRadius: 6, padding: '3px 9px', fontSize: '0.75rem', fontWeight: 600 }),
            ...
            return (
              <div key={order.id} style={S.card}>
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  <span style={S.typeBadge('#14a89a')}><DollarSign size={12} />Заказ</span>

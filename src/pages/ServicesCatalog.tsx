...
const S: Record<string, any> = {
  ...
  card: { background: '#0f1923', border: '1px solid #1e3a4a', borderRadius: 12, padding: '1.25rem', textDecoration: 'none', display: 'flex', flexDirection: 'column', gap: 10 },
  ...
  badge: (color: string) => ({ background: color + '22', color, border: `1px solid ${color}44`, borderRadius: 12, padding: '3px 8px', fontSize: '0.72rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }),

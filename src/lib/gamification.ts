...
export const ACHIEVEMENTS: Record<string, AchievementDef> = {
  ...
  top_rated:        { emoji: '⭐', name: 'Топ рейтинг',           desc: 'Получите 10+ отзывов на бирже со средним рейтингом не ниже 4.8' },
  perfect_score:    { emoji: '✨', name: 'Идеальный результат',   desc: 'Получите 5 отзывов подряд с оценкой 5.0' },
  ...
  gost_master:      { emoji: '📄', name: 'Мастер ГОСТа',          desc: 'Сгенерируйте 10 документов в ГОСТ-калькуляторе' },
  wallet_top:       { emoji: '💰', name: 'Меценат',               desc: 'Пополните баланс кошелька на 5000 ₽ суммарно' },
  referrer:         { emoji: '👥', name: 'Амбассадор',            desc: 'Пригласите 3 друзей, которые пополнят баланс по вашей реферальной ссылке' },
}
